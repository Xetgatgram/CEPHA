...
/**
 * Buffered ProcessWindowFunction für COUNT-BASED windows.
 */
public class BuffGlobalDetectionProcessWindow
        extends AbstractBuffDetectionProcessWindow<GlobalWindow> {

    private static final long serialVersionUID = 1L;

    public BuffGlobalDetectionProcessWindow(
